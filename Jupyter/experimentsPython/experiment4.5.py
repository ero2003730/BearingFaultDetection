...
def main():
    ...
    lstm_configs = [
        # Novas
        {"architecture": "bidirectional",           "layers": [128, 64], "dropout": False, "bidirectional": True},
        {"architecture": "bidirectional_dropout",   "layers": [128, 64], "dropout": True,  "bidirectional": True},
        {"architecture": "batch_norm",              "layers": [128, 64], "dropout": False, "batch_norm": True},
        {"architecture": "batch_norm_dropout",      "layers": [128, 64], "dropout": True,  "batch_norm": True}
    ]
